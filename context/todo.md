...
`docs/hardware-validation-v0.4.10.md`), and **v0.4.11 is RELEASED**. Last RELEASED version is now
...
- [x] **v0.4.11 RELEASED (done 2026-08-06)**: consolidates the pre-1.0 gate-4 hardening (0.4.3->0.4.11).
      ...
      systemd-cgroup-kill variant not run (secondary). Sign-off: `docs/hardware-validation-v0.4.10.md`.
