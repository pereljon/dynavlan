...
- [x] VLAN_LIMIT feature (approved + done 2026-07-23): VLAN_WARN=32 (renamed from VLAN_COUNT_WARN), VLAN_LIMIT=64 (0=unlimited), VLAN_LIMIT_MODE=refuse|fill (default refuse). FR-36/AC-13 in PRD v3.2; tests 1f; wired into boot/rescan/relocation/dry-run.
